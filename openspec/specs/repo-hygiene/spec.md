...
Defines repo-level hygiene rules for test placement and documentation layout
in the `shenzhen-bird-map` WeChat Mini Program. The rules apply to the repo
root and the `miniprogram/` source tree.
